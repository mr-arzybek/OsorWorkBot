...
def sql_create_moscow_2():
    ...
    cursor_moscow_2.execute(sql_queris_moscow_2.CREATE_PRODUCT_TABLE_QUERY)
...
async def moscow_2_sql_product_insert(state):
    async with state.proxy() as data:
        cursor_moscow_2.execute(sql_queris_moscow_2.PRODUCT_INSERT_QUERY, tuple(data.values()))
        db_moscow_2.commit()
